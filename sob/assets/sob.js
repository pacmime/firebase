        ...
        return {
            ...
            link: function($scope, $element, $attrs, ngModelController) {
                ...
                function update() {
                    ...
                    var image = '<img alt="avatar" style="max-height:100px" src="' + $scope.imgData + '">';
                ...
                $element.find('input').on('change', onFileSelect);
...
angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('character/body.html',
    ...
    "            \n" +
    "            <ng-include src=\"src/character/items.html\" />\n" +
    "\n" +
    "        </div>\n" +
    "\n" +
    "        <div class=\"grid__col-sm-12 grid__col-md-6\">\n" +
    "\n" +
    "            <ng-include src=\"src/character/abilities.html\" />\n" +
    "\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>"
  ...
  $templateCache.put('character/character.html',
    "<div class=\"page\">\n" +
    "\n" +
    "    <ng-include src=\"src/character/header.html\" />\n" +
    "\n" +
    "    <ng-include src=\"src/character/body.html\" />\n" +
    "\n" +
    "    <ng-include src=\"src/character/footer.html\" />\n" +
    "\n" +
    "</div>"
  );
  ...
  $templateCache.put('character/footer.html',
    ...
    "\n" +
    "                    <ng-include src=\"src/character/sidebag.html\" />    \n" +
    "                    \n" +
    "                </div>\n" +
    "                \n" +
    "                <div class=\"grid__col-xs-7 grid__col-sm-8\">\n" +
    "\n" +
    "                    <ng-include src=\"src/character/health.html\" />\n" +
    "\n" +
    "                    <ng-include src=\"src/character/sanity.html\" />\n" +
    "                    \n" +
    "                    <ng-include src=\"src/character/faith-and-corruption.html\" />\n" +
    "                    \n" +
    "                    <ng-include src=\"src/character/move-and-grit.html\" />\n" +
    "\n" +
    "                </div>\n" +
    "                \n" +
    "            </div>\n" +
    ...
    "        <div class=\"grid__col-sm-12 grid__col-md-6\">\n" +
    "\n" +
    "            <ng-include src=\"src/character/clothing.html\" />\n" +
    "\n" +
    "            <ng-include src=\"src/character/mutations-and-injuries.html\" />\n" +
    "\n" +
    "        </div>\n" +
    "    </div>\n" +
    "\n" +
  ...
  $templateCache.put('character/header.html',
    ...
    "\n" +
    "                <!-- avatar -->\n" +
    "                <div class=\"grid__col-xs-3 grid--align-self-end\">\n" +
    ...
    "\n" +
    "            <ng-include src=\"src/character/stats.html\" />\n" +
    "\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</header>"
