...
var AbilitiesComponent = /** @class */ (function () {
    function AbilitiesComponent(afs, dialog) {
        this.afs = afs;
    ...
    AbilitiesComponent.prototype.openChooser = function () {
        ...
        this.getChooserOptions().then(function (options) {
            ...
            var dialogRef = _this.dialog.open(_chooser_chooser_component__WEBPACK_IMPORTED_MODULE_4__["AbilityChooserComponent"], opts);
...
var AbilityChooserComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AbilityChooserComponent, _super);
    function AbilityChooserComponent(dialogRef, data) {
    ...
    AbilityChooserComponent.prototype.choose = function (ability) {
        ...
        if (this.isChosen(ability))
            ...
            if (ability.desc)
                ...
                var value = JSON.parse(JSON.stringify(ability));
    ...
    AbilityChooserComponent.ctorParameters = function () { return [
...
var UsagePipe = /** @class */ (function () {
    function UsagePipe() {
    }
    UsagePipe.prototype.transform = function (value) {
        if (!value || !value.length)
            return [];
        var list = value.filter(function (v) { return !!v.usage; });
        list.sort(function (a, b) { return a.usage > b.usage ? 1 : -1; });
        return list;
    };
...
var SumFilterPipe = /** @class */ (function () {
    ...
    SumFilterPipe.prototype.transform = function (values, min) {
        var result = 0, minimum = 0;
        if (!isNaN(min))
            minimum = min * 1;
...
var AttackComponent = /** @class */ (function () {
    ...
    AttackComponent.prototype.execute = function () {
        var result = { attack: null, hits: [], dmg: [], totalDmg: 0, bounces: [] };
        if (!this.details) {
        ...
        //     }
        // }
        for (var i = 0, hits = 0; i < this.details.numAttDie; ++i) {
            //roll to-hit
     ...
     */
    AttackComponent.prototype.rerollHit = function (index) {
        var _this = this;
        ...
        //re-sum total damage
        result.totalDmg = 0;
        result.dmg.forEach(function (d, i) {
            if (result.hits[i] >= _this.details.target) {
                result.totalDmg += d;
            }
        });
        result.bounces = this.rollBounces();
     ...
     */
    AttackComponent.prototype.rerollDmg = function (index) {
        var _this = this;
        var result = this.roll;
        var dmg = Math.ceil(Math.random() * this.details.dmgDie);
        if (this.details.dmgMod)
...
module.exports = ".l-char {\n  flex-wrap: nowrap;\n  -webkit-box-align: stretch;\n          align-items: stretch;\n  overflow-y: hidden;\n  overflow-x: auto;\n  height: 100%;\n  -webkit-overflow-scrolling: touch;\n}\n.l-page {\n  -webkit-box-flex: 1;\n          flex: 1 0 100%;\n  overflow-y: auto;\n  white-space: normal;\n}\n/* IPAD\n@media(min-width:375px) {\n    .l-page { flex: 1 0 375px; }\n}*/\n@media (min-width: 1024px) {\n  .l-page {\n    -webkit-box-flex: 1;\n            flex: 1 0 1024px;\n    overflow-y: auto;\n    white-space: normal;\n    padding: 0.5em 0.5em 1em;\n  }\n}\n.mat-tab-group {\n  width: 100%;\n}\nsection {\n  display: -webkit-box;\n  display: flex;\n  justify-content: space-around;\n  -webkit-box-align: center;\n          align-items: center;\n  padding: 0.25em 0;\n  background-image: url('texture.png');\n}\nsection > section {\n  -webkit-box-flex: 1;\n          flex: 1;\n}\nsection.misc {\n  padding: 0;\n  -webkit-box-pack: stretch;\n          justify-content: stretch;\n}\n.swipe--left {\n  position: absolute;\n  left: 0;\n  bottom: 2em;\n  z-index: 100;\n}\n.swipe--right {\n  position: absolute;\n  right: 0;\n  bottom: 2em;\n  z-index: 100;\n}\n\\ .o-container {\n  background: #cd9c3b;\n  border: 1px solid #777;\n  margin-right: 0.5em;\n}\n.o-container--attrs {\n  background: #cd9c3b;\n  border: 1px solid #777;\n  margin-right: 0.5em;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-pack: start;\n          justify-content: flex-start;\n  -webkit-box-align: stretch;\n          align-items: stretch;\n  font-size: 0.875em;\n  background-color: #cd9c3b;\n  background-image: url('texture.png');\n}\n.o-container--bio {\n  border-bottom: 1px solid #bbb;\n  margin-bottom: 1em;\n}\n@media (min-width: 992px) {\n  .o-container--bio {\n    -webkit-box-flex: 1;\n            flex: 1;\n    border-bottom: none;\n  }\n  .o-attributes-container {\n    -webkit-box-flex: 3;\n            flex: 3;\n  }\n}\n.m-attributes {\n  -webkit-box-flex: 6;\n          flex: 6;\n  display: -webkit-box;\n  display: flex;\n  flex-wrap: wrap;\n  -webkit-box-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n          justify-content: center;\n}\n.m-attributes > * {\n  -webkit-box-flex: 1;\n          flex: 1 0 33%;\n  text-align: center;\n}\n.m-attributes .value-display .label {\n  background-color: #000;\n  color: #fff;\n}\n.m-stats {\n  -webkit-box-flex: 4;\n          flex: 4;\n  background-color: #e7c581;\n  background-image: url('texture.png');\n}\n.m-stats .o-container {\n  display: -webkit-box;\n  display: flex;\n  justify-content: space-around;\n  -webkit-box-align: center;\n          align-items: center;\n}\n.bio {\n  position: relative;\n  padding: 0.25em 0.25em 0;\n  border: 1px solid #bbb;\n  background: #f7f7f787;\n  text-align: center;\n}\n.bio .edit-button {\n  position: absolute;\n  right: 0;\n  top: 0;\n}\n.m-sidebag-chip {\n  border: 1px solid #777;\n  border-radius: 24px;\n  background: #efefef;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-pack: justify;\n          justify-content: space-between;\n  -webkit-box-align: center;\n          align-items: center;\n}\n.t-combat,\n.t-health,\n.t-sanity,\n.t-grit,\n.t-corruption,\n.t-faith,\n.t-mana,\n.t-magik,\n.t-fury,\n.t-ki,\n.t-resources {\n  -webkit-box-flex: 1;\n          flex: auto;\n  justify-content: space-around;\n}\n.t-combat > .m-grid,\n.t-health > .m-grid,\n.t-sanity > .m-grid,\n.t-grit > .m-grid,\n.t-corruption > .m-grid,\n.t-faith > .m-grid,\n.t-mana > .m-grid,\n.t-magik > .m-grid,\n.t-fury > .m-grid,\n.t-ki > .m-grid,\n.t-resources > .m-grid {\n  justify-content: space-around;\n}\n.t-health > .m-grid,\n.t-sanity > .m-grid {\n  justify-content: space-around;\n}\n.t-health > .m-grid > *,\n.t-sanity > .m-grid > * {\n  -webkit-box-flex: 1;\n          flex: 1;\n  text-align: center;\n}\n.t-health > .m-grid .m-grid,\n.t-sanity > .m-grid .m-grid {\n  justify-content: space-around;\n}\n@media (min-width: 768px) {\n  .t-health > .m-grid > *,\n  .t-sanity > .m-grid > * {\n    -webkit-box-flex: 1;\n            flex: auto;\n  }\n  .t-corruption,\n  .t-faith,\n  .t-mana,\n  .t-magik,\n  .t-fury,\n  .t-ki,\n  .t-resources {\n    -webkit-box-flex: 1;\n            flex: 1 0 auto;\n    padding: 0.5em;\n  }\n}\n@media (min-width: 992px) {\n  .t-combat {\n    -webkit-box-pack: start;\n            justify-content: flex-start;\n  }\n  .t-health,\n  .t-sanity {\n    -webkit-box-flex: 1;\n            flex: 1;\n    -webkit-box-pack: start;\n            justify-content: flex-start;\n  }\n  .t-health > .m-grid,\n  .t-sanity > .m-grid {\n    -webkit-box-pack: start;\n            justify-content: flex-start;\n  }\n  .t-health > .m-grid > *,\n  .t-sanity > .m-grid > * {\n    -webkit-box-flex: 1;\n            flex: auto;\n  }\n  .t-grit,\n  .t-corruption,\n  .t-faith,\n  .t-mana,\n  .t-magik,\n  .t-fury,\n  .t-ki,\n  .t-resources {\n    -webkit-box-flex: 0;\n            flex: 0 1 auto;\n    -webkit-box-pack: start;\n            justify-content: flex-start;\n  }\n  .t-combat > .m-grid,\n  .t-health > .m-grid,\n  .t-sanity > .m-grid,\n  .t-grit > .m-grid,\n  .t-corruption > .m-grid,\n  .t-faith > .m-grid,\n  .t-mana > .m-grid,\n  .t-magik > .m-grid,\n  .t-fury > .m-grid,\n  .t-ki > .m-grid,\n  .t-resources > .m-grid {\n    -webkit-box-pack: start;\n            justify-content: flex-start;\n  }\n  .t-combat > .m-grid .m-grid,\n  .t-health > .m-grid .m-grid,\n  .t-sanity > .m-grid .m-grid,\n  .t-grit > .m-grid .m-grid,\n  .t-corruption > .m-grid .m-grid,\n  .t-faith > .m-grid .m-grid,\n  .t-mana > .m-grid .m-grid,\n  .t-magik > .m-grid .m-grid,\n  .t-fury > .m-grid .m-grid,\n  .t-ki > .m-grid .m-grid,\n  .t-resources > .m-grid .m-grid {\n    -webkit-box-pack: start;\n            justify-content: flex-start;\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CharacterComponent = /** @class */ (function () {
    ...
    CharacterComponent.prototype.doSave = function () {
        ...
        this.service.updateCharacter(this.charId, this.character)
            ...
            _this.snackBar.open("Unable to save character because " + e.message, "Dismiss");
        });
    };
...
var FactionChooserComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](FactionChooserComponent, _super);
    function FactionChooserComponent(dialogRef, data) {
        var _this = _super.call(this, dialogRef, data) || this;
        _this.selection = null;
        _this.groupToggles = {
            paths: false,
    ...
    FactionChooserComponent.prototype.choose = function (faction) {
        if (this.isChosen(faction))
            ...
            if (faction.desc)
                ...
                var value = JSON.parse(JSON.stringify(faction));
    ...
    FactionChooserComponent.ctorParameters = function () { return [
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"],] }] }
    ]; };
...
var FactionComponent = /** @class */ (function () {
    function FactionComponent(afs, dialog) {
        this.afs = afs;
        this.onSave = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.onError = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.label = "Faction";
    ...
    FactionComponent.prototype.openChooser = function () {
        ...
        this.getChooserOptions().then(function (options) {
            ...
            var dialogRef = _this.dialog.open(_chooser_chooser_component__WEBPACK_IMPORTED_MODULE_4__["FactionChooserComponent"], opts);
            _this.subscription = dialogRef.afterClosed().subscribe(function (result) {
                if (result) {
                    _this.add(result);
                }
...
var ItemComponent = /** @class */ (function () {
     ...
     *
     */
    ItemComponent.prototype.editItem = function () { this.onEvent.emit({ type: _models_character_model__WEBPACK_IMPORTED_MODULE_2__["Events"].ITEM_EDIT, item: this.item }); };
    /**
     *
     */
    ItemComponent.prototype.removeItem = function () { this.onEvent.emit({ type: _models_character_model__WEBPACK_IMPORTED_MODULE_2__["Events"].ITEM_REMOVE, item: this.item }); };
    /**
     *
     */
    ItemComponent.prototype.equipItem = function () { this.onEvent.emit({ type: _models_character_model__WEBPACK_IMPORTED_MODULE_2__["Events"].ITEM_EQUIP, item: this.item }); };
    /**
     *
     */
    ItemComponent.prototype.confirmingDelete = function (value) {
        if (typeof (value) !== 'undefined' && value !== null) {
...
var ItemsComponent = /** @class */ (function () {
    ...
    ItemsComponent.prototype.ngOnChanges = function (changes) {
        if (changes.items) {
            this.updateTotals();
        }
    };
     ...
     *
     */
    ItemsComponent.prototype.onItemEvent = function (event, index) {
        var type = event.type;
        var item = event.item;
        switch (type) {
    ...
    ItemsComponent.prototype.openEditor = function (item, position) {
        var _this = this;
        var opts = { data: { item: item } };
        var dialogRef = this.dialog.open(_editor_editor_component__WEBPACK_IMPORTED_MODULE_4__["ItemEditorComponent"], opts);
     ...
     *
     */
    ItemsComponent.prototype.createBlankItem = function () {
        return {
            name: "",
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.service.login(this.email, this.password)
            .then(function (user) { _this.router.navigate(['/chars']); })
            .catch(function (e) {
            _this.message = "Unable to log because of an error - " + e.message;
        });
    };
    /**
     *
...
/*!*******************************************!*\
  !*** ./src/app/models/character.model.ts ***!
  \*******************************************/
/*! exports provided: Events, SPECIAL_CLASSES, ClassFlag */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var UsesComponent = /** @class */ (function () {
    function UsesComponent() {
        this.items = [];
        this.onSave = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.showDesc = {};
    }
    UsesComponent.prototype.ngOnInit = function () {
    };
    UsesComponent.prototype.use = function (item) {
        item.used = !item.used;
    };
    UsesComponent.prototype.reset = function () {
        this.items.forEach(function (item) {
            if (item.used)
                item.used = false;
        });
...
var ValueDisplayComponent = /** @class */ (function () {
    ...
    ValueDisplayComponent.prototype.applyModifiers = function () {
...
var ValueDisplayWithMaxComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ValueDisplayWithMaxComponent, _super);
    function ValueDisplayWithMaxComponent() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.max = 0;
        return _this;
    }
    /** @override */
    ValueDisplayWithMaxComponent.prototype.applyModifiers = function () {
        var modifier = this.modifiers ? this.modifiers.value * 1 : 0;
        if (modifier) {
    ...
    return ValueDisplayWithMaxComponent;
}(ValueDisplayComponent));
