...
let AbilitiesComponent = class AbilitiesComponent {
    ...
    openChooser() {
        const ref = this.modalService.createComponentRef(_chooser_chooser_component__WEBPACK_IMPORTED_MODULE_4__["AbilityChooserComponent"]);
...
let AbilityChooserComponent = class AbilityChooserComponent {
    constructor() {
        this.closable = true;
        this.visible = true;
        this.selection = null;
...
let AttackComponent = class AttackComponent {
     ...
     */
    execute() {
        let result = { attack: null, hits: [], dmg: [], bounces: [] };
        if (!this.details) {
...
let CharacterComponent = class CharacterComponent {
    ...
    doSave() {
        ...
        this.service.updateCharacter(this.charId, this.character)
            ...
            this.snackBarRef.dismiss();
            this.snackBarRef = null;
            this.error = new _models_error__WEBPACK_IMPORTED_MODULE_7__["SOBError"]("save", "Unable to save character changes, because " + e.message);
        });
    }
    getWeightLimit() {
...
let FactionChooserComponent = class FactionChooserComponent {
    constructor() {
        this.closable = true;
        this.visible = true;
        this.selection = null;
...
let FactionComponent = class FactionComponent {
    ...
    openChooser() {
        const ref = this.modalService.createComponentRef(_chooser_chooser_component__WEBPACK_IMPORTED_MODULE_4__["FactionChooserComponent"]);
...
let ItemsComponent = class ItemsComponent {
    ...
    openEditor(item, position) {
        ...
        const dialogRef = this.dialog.open(_editor_editor_component__WEBPACK_IMPORTED_MODULE_3__["ItemEditorComponent"], opts);
